...
This address can receive ETH and ERC-20 tokens on Ethereum mainnet. For USDT payments, the sender must use USDT on Ethereum / ERC20.
...
- `index.html`: public experiment page
...
- `screening-reports/`: low-touch task screening reports
- `tether-bounty-application-draft.md`: draft application material

## Safety Rules

- Only public wallet addresses are shown.
